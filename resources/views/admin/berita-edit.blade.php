...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.berita.update')}}">
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="caption" id="caption" placeholder="Caption Gambar" value="{{$berita->caption}}">

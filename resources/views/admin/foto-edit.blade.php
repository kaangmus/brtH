...
<main class="app-content">
    ...
    <div class="row">
            <div class="col-md-12">
                <div class="tile">
                  <div class="tile-body">
                        <form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.foto.update')}}">
                            {{ csrf_field() }} @method('put') <input type="hidden" name="id" value="{{$foto->id}}">
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi foto" rows="8">{{$foto->deskripsi}}</textarea>
                            ...
                            <div class="col-sm-12 col-md-3">
                                @if (!empty($foto->foto))
                                    <img src="{{asset($foto->foto)}}" style="max-height: 130px" class="rounded" alt="thumbnail" id="gambar">
                                @else

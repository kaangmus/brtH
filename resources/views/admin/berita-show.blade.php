        ...
        <div class="col-md-9 col-sm-12">
            ...
            <div class="tile-footer">
                ...
                <div class="btn-group float-right" role="group" aria-label="Basic example">
                    ...
                    <button class="btn btn-outline-danger mr-1 mb-1 btn-sm" data-pesan="Apakah kamu yakin ingin menghapu deskripsi berita {{$berita->judul}}" data-url="{{route('admin.berita.delete', ['id'=> $berita->id])}}" data-redirect="{{route('admin.berita')}}" id="hapus">

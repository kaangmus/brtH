...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.atribut.update')}}">
                    {{ csrf_field() }} @method('put') <input type="hidden" name="id" value="{{$atribut->id}}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                           <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="atribut" id="atribut" placeholder="Judul Atribut" value="{{$atribut->atribut}}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <textarea id="deskripsi" name="deskripsi">{{$atribut->deskripsi}}</textarea>
                        </div>
                    </div>

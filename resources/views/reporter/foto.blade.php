...
<main class="app-content">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-12">
                <div class="tile">
                <form action="{{ route('reporter.foto.store') }}" class="dropzone" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                </form>
                </div>
        </div>
                        ...
                        @foreach ($fotos as $foto)
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button onClick="hapus('{{route('reporter.foto.delete', ['id'=> $foto->id])}}', 'Foto yakin ingin dihapus')" class="btn btn-danger btn-sm float-right">Hapus</button>
...
<script>
    function publish(no) {
        $.get('{{ route('reporter.foto.publish')}}?id='+no, function(response){

                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="{{route('reporter.video.show',['id'=>$video->id])}}" class="btn btn-sm btn-primary">Detail</a>
                                <a class="btn btn-light btn-sm" href="{{route('reporter.video.edit', ['id'=> $video->id])}}">

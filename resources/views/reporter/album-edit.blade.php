...
<main class="app-content">
    ...
    <div class="row">
            <div class="col-md-12">
                <div class="tile">
                  <div class="tile-body">
                    <form class="form-horizontal" id="submit-form" method="post" action="{{route('reporter.album.update')}}">
                    {{ csrf_field() }} <input type="hidden" name="id" value="{{$album->id}}"> @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="album" id="album" placeholder="Album Baru" value="{{$album->album}}">
                                        @if ($errors->has('album'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea  class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskrispi Album" rows="8">{{$album->deskripsi}}</textarea>
